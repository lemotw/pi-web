...
function loadServiceWorker({ clients = [] } = {}) {
  ...
  const code = readFileSync(resolve(process.cwd(), '../internal/ui/live_templates/sw.js'), 'utf8');
  vm.runInNewContext(code, { self }, { filename: 'internal/ui/live_templates/sw.js' });
